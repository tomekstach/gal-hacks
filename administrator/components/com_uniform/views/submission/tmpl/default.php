...
<div class="span6 submission-details" style=" position: relative;">
	...
	<?php if (count($logs)):?>
	<h2 class="jsn-section-header"><?php echo JText::_('JSN_UNIFORM_SUBMISSION_HISTORY'); ?></h2>
	<div class="jsn-section-content">
		<?php foreach ($logs as $key => $log):?>
		<table class="table table-bordered">
			<tr>
				<th width="40%"><?php echo $log->user;?></th>
				<td width="60%"><?php echo $log->date;?></td>
			</tr>
			<?php foreach ($log->data as $k => $logdata):?>
			<tr>
				<th><?php echo $logdata->field_name;?></th>
				<td>
					<table>
						<tr>
							<td style="border: 0!important;">stara: </td>
							<td style="border: 0!important;"><?php echo $logdata->field_value_old;?></td>
						</tr>
						<tr>
							<td style="border: 0!important;">nowa:</td>
							<td style="border: 0!important;"><?php echo $logdata->field_value_new;?></td>
						</tr>
					</table>
				</td>
			</tr>
